...
"""Unitree G1 keyboard teleop via ControlCoordinator over WebRTC.

WASD keys → Twist → coordinator twist_command → UnitreeG1WebRTCAdapter.
...
Usage:
    dimos --simulation run unitree-g1-webrtc-keyboard-teleop   # MuJoCo sim
    dimos run unitree-g1-webrtc-keyboard-teleop                # real hardware (WebRTC)
"""
...
unitree_g1_webrtc_keyboard_teleop = autoconnect(_g1, _teleop)

__all__ = ["unitree_g1_webrtc_keyboard_teleop"]

...
WASD keys → Twist on /cmd_vel → coordinator twist_command → UnitreeGo2Adapter.
...
_coordinator_go2 = control_coordinator(
    hardware=[
        HardwareComponent(
            hardware_id="go2",
...
unitree_go2_keyboard_teleop = autoconnect(
    _coordinator_go2,
    keyboard_teleop().transports(
        {

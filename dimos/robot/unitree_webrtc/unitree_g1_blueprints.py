...
# -----------------------------------------------------------------------------
# Public blueprint exports (referenced by `dimos/robot/all_blueprints.py`)
# -----------------------------------------------------------------------------
#
# The blueprint registry is auto-generated by scanning for top-level assignments
# that *create* blueprints (autoconnect(...) or chaining methods like .global_config()).
# Simple aliases (unitree_g1_sim = standard_sim) are NOT detected by the generator.
#
# Therefore these exports intentionally use .global_config(...) to be detected while
# remaining semantically identical to the underlying blueprint.

# Core stacks
unitree_g1_basic = basic_ros.global_config(n_dask_workers=4, robot_model="unitree_g1")
unitree_g1_basic_sim = basic_sim.global_config(n_dask_workers=4, robot_model="unitree_g1")
unitree_g1 = standard.global_config(n_dask_workers=8)
unitree_g1_sim = standard_sim.global_config(n_dask_workers=8)
unitree_g1_shm = standard_with_shm.global_config(n_dask_workers=8)

# Agentic stacks
unitree_g1_agentic = agentic.global_config(n_dask_workers=8)
unitree_g1_agentic_sim = agentic_sim.global_config(n_dask_workers=8)

# Feature-specific stacks
unitree_g1_joystick = with_joystick.global_config(n_dask_workers=4, robot_model="unitree_g1")
unitree_g1_detection = detection.global_config(n_dask_workers=8)
unitree_g1_full = full_featured.global_config(n_dask_workers=8)

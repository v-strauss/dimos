...
def main():
    ...
    robot = UnitreeGo2(
        ip=os.getenv("ROBOT_IP", "192.168.123.161"), skills=MyUnitreeSkills(), mock_connection=True
    )
    ...
    with open(memory_file, "a") as f:
        f.write(
            "SKILL CALL: ObserveStream(timestep=10.0, query_text='What do you see in this image? Alert me if you see any people.', max_duration=120.0)"
        )

...
def main():
    ...
    person_tracker = PersonTrackingStream(
        camera_intrinsics=camera_intrinsics, camera_pitch=camera_pitch, camera_height=camera_height
    )
            ...
            try:
                ...
                if selected_point is not None:
                    ...
                    if tracking_active:
                        ...
                        status_color = (
                            (0, 255, 0) if running else (0, 0, 255)
                        ...
                        cv2.putText(
                            frame,
                            f"Tracking: {'ON' if running else 'OFF'}",
                            (10, 90),
                            cv2.FONT_HERSHEY_SIMPLEX,
                            0.7,
                            status_color,
